...
- 주요 테스트 그룹
  ...
  - 워크플로: `test_start_chat_lg_graph.py`, `test_translator_lg_graph.py`, `test_chart_maker_lg_graph.py`, `test_travel_planner_lg_graph.py`, `test_lg_orchestrator.py`
...
9. 필요한 하위 워크플로 패키지 (`translator`, `chart_maker`, `travel_planner`)
