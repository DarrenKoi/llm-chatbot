...
Ingest 대상: doc/llm-wiki/raw/learning-logs/

작업 순서:
1. 대상 raw 파일들을 하나씩 읽고 핵심 정보 추출.
2. 영향받는 wiki/ 페이지 식별 — 신규 wiki/concepts/ 에 workflow md 파일들을 만들어 정리
...
6. wiki/log.md 최상단에 ingest 항목 prepend:
   예시 ## [2026-05-01] ingest | raw/learning-logs/20260501-langgraph-state.md (by 대영)
   - <변경 내역>
7. raw/ 는 절대 수정하지 말 것.
